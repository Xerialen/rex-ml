...
static __thread hull_t		box_hull;         /* QWSIM-EDIT-6: thread-local; CM_Init() must be */
static __thread mclipnode_t	box_clipnodes[6]; /* QWSIM-EDIT-7: called once per worker thread   */
static __thread mplane_t	box_planes[6];    /* QWSIM-EDIT-8: before any box-hull use         */
