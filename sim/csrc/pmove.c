...
movevars_t      movevars;
__thread playermove_t    pmove;            /* QWSIM-EDIT-1: thread-local for batched slots */

static __thread float	pm_frametime;      /* QWSIM-EDIT-2: thread-local for batched slots */

static __thread vec3_t	pm_forward, pm_right;  /* QWSIM-EDIT-3: thread-local for batched slots */

static __thread vec3_t   groundnormal;     /* QWSIM-EDIT-4: thread-local for batched slots */
